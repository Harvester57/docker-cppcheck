...
LABEL lastupdate "2022-08-29"
LABEL author "Florian Stosse"
LABEL description "CppCheck v2.9, built using Alpine image v3.16"
...
RUN git clone --branch 2.9 https://github.com/danmar/cppcheck.git --depth 1
